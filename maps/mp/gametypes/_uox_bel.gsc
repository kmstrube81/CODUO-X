...
UOX_Main()
{
    ...
    level.AlivePointTime = maps\mp\uox\_uox_vars::varDef("scr", "alivepointtime", "int", true, 10, 1, 1440, "Seconds Per Survival Point");
	level.PositionUpdateTime = maps\mp\uox\_uox_vars::varDef("scr", "positiontime", "int", true, 10, 1, 1440, "Seconds Per Compass Update");

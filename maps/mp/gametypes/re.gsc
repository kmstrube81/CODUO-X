...
main()
{
	...
	if(isDefined(maps\mp\uox\_uox_arrays::getValue(game["mods"],"main"))) //if main thread already ran then exit stock gametype
		return;
...
// RF, removed this, since people can get max rank by just dropping the item repeatedly
/*
	if ( level.battlerank )
	{
		player.pers["score"] += 3;
